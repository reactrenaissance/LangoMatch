import { View, Text, StyleSheet, TextInput, Button, Image, Platform, ActivityIndicator} from "react-native";
...
export default function ProfileCreation({ navigation }) {
    ...
    const goToWelcomeScreen = async () => {
        if (!displayName || !profileImageUri || bio.length < 20) {
    ...
    return (
        <View>
            ...
            <Text style={{textAlign: 'center', marginBottom: 10,}}>Upload your profile picture</Text>
            ...
            onPress={(data, details = null) => {
                ...
                query={{
                    key: 'AIzaSyDtyfzmqYtM-vS5BugPYQjTeN43BuNZZf4',
                    language: 'en',
                    types: '(cities)',
                }}
                styles={{
            ...
            <CustomButton 
            style={styles.DoneButton} title='Done' 
